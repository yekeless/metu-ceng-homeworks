...
# 16 "./pragmas.h" 2
# 1 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8/pic/include/p18cxxx.h" 1 3
# 17 "./pragmas.h" 2
...
# 173 "/opt/microchip/xc8/v2.30/pic/include/c99/bits/alltypes.h" 3
...
# 209 "/opt/microchip/xc8/v2.30/pic/include/c99/bits/alltypes.h" 3
...
typedef enum {INBUF = 1, OUTBUF = 0} buf_t;
...
int rb4_prev, rb5_prev, rb6_prev, rb7_prev;
int rb4_pressed_flag, rb5_pressed_flag, rb6_pressed_flag, rb7_pressed_flag;
int rb4mode, rb5mode, rb6mode, rb7mode;
...
void buffer_push (char c, buf_t buf_type){
    ...
    if(buf_type == INBUF){
        ...
        if(input.head == 128) input.head = 0;
        ...
        if(output.head == 128) output.head = 0;
...
char buffer_pop (buf_t buf_type){
    ...
    if(buf_type == INBUF){
        ...
        input.tail++;
        if(input.tail == 128) input.tail = 0;
    }
    else{
        ...
        output.tail++;
        if(output.tail == 128) output.tail = 0;
    }
...
void __attribute__((picinterrupt(("high_priority")))) highPriorityISR (void) {
    ...
    if (INTCONbits.RBIF == 1){
        INTCONbits.RBIF = 0;
        if(rb4_prev != PORTBbits.RB4 && rb4mode){
            rb4_prev = PORTBbits.RB4;
            if(PORTBbits.RB4 == 1){
                rb4_pressed_flag = 1;
            }
