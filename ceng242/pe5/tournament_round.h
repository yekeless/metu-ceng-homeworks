...
public:
    ...
    TournamentRound(TournamentRound &other) : bands(other.bands) { bands = other.bands; }
    TournamentRound(TournamentRound &&other) : bands(std::move(other.bands)) { bands = std::move(other.bands); }
